...
class R2Test(BaseCase):
    ...
    def register_test_user(self, *_):
        ...
        self.input('#password2', test_user.password)
    ...
    def test_r2_5_neg_password(self, *_):
        ...
        for password in test_user_bad_password.password:
            self.open(base_url+'/register')
            self.input('#email', test_user.email)
            self.input('#name', test_user.name)
            self.input('#password2', test_user.password)
    ...
    def test_r2_5_neg_password2(self, *_):
        ...
        # with remaining valid information to verifies that there is an error message
        # and there is no POST
        for password2 in test_user_bad_password.password:
            self.open(base_url+'/register')
            self.input('#email', test_user.email)
            self.input('#name', test_user.name)
            self.input('#password', test_user.password)
    ...
    def test_r2_6_neg(self, *_):
        ...
        self.input('#password2', test_user_bad_password2.password)
