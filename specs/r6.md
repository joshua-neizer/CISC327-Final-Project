...
##R6.4
**The ticket name exists in the database - positive**
...
##R6.4
**The ticket name exists in the database - negative**
...
##R6.4
**The ticket quantity is more than the quantity requested to buy - positive**
...
##R6.4
**The ticket quantity is more than the quantity requested to buy - negative**
