...
* open /
* enter `alphanumeric123` into element `#update_name`
...
* click element `input[type="submit"]`
* open /
* enter `shortticketname` into element `#update_name`
* enter `1` into element `#update_quantity`
* enter `20` into element `#update_price`
* enter `20210517` into element `#update_date`
* click element `#update_submit`
...
Mocking:
* Mock backend.get_user to return a test_user instance
* Mock ticket `ticket does exist` with `price=50,quantity=20` for user
